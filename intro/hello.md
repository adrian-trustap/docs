...
```CURL {% title="Create a guest buyer" %}
...
## Next steps
1. Follow our [setup](./auth.md) guide to get your API key and start developing for your own account.
2. Start working with our [guides](../guides/transactions/face-to-face/face-to-face-intro.md).
3. Explore our [API reference](../../apis/openapi.yaml).
