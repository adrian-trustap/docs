...
2. Show the fees to the user.
3. Create a new transaction (or update an existing transaction) by adding the
...
See our [charge configuration guide](../guides/charge-config.md) for more information on to setup and use different charge configurations with the Trustap API.
...
* Seller fees are not displayed in the Trustap payment screen but are available in the [charge endpoint](../../apis/openapi/online-payment/basic%2Egetcharge#online-payment/basic%2Egetcharge/t=response&c=200&path=charge_seller).
