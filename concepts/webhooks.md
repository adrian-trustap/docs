...
[setup](../intro/auth.md). Trustap sends all webhook events associated
...
Trustap includes a Basic Authentication header in each webhook request. You can use the username and password to verify the request is from Trustap. Set these credentials when configuring your webhook endpoint and as part of your [Trustap setup](../intro/auth.md).
...
1. [Create a guest seller](../guides/transactions/online/online-int-path.md#step-1-create-a-guest-seller)
2. [Create a guest buyer](../guides/transactions/online/online-int-path.md#step-2-create-a-guest-buyer)
3. [Calculate the charge](../guides/transactions/online/online-int-path.md#step-3-get-trustap-fee-charge)
4. [Create a transaction](../guides/transactions/online/online-int-path.md#step-4-create-a-transaction-with-a-guest-seller-and-guest-buyer)
